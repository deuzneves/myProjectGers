...
import Services from "./documentation/Services";
...
export default () => (
  <Switch>
    ...
    <RouteWithLoader exact path={Routes.Services.path} component={Services} />
    <RouteWithLoader exact path={Routes.Booking.path} component={Booking} />
