...
const getReservation = async () =>  
  {
     fetch('http://localhost:3001/api/insert2')
      ...
      <tr>
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              <Dropdown.Item>
                <FontAwesomeIcon icon={faEye} className="me-2" /> Assign to a staff
              </Dropdown.Item>
              <Dropdown.Item>
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      <Card.Body className="pt-0">
        <Table hover className="user-table align-items-center">
          ...
          <tbody>
          {booking.map(t => <TableRow key={t.id} {...t} />)}
          </tbody>
        </Table>
...
export const TransactionsTable2 = () => {
...
const getReservation2 = async () =>  
  {
    fetch('http://localhost:3001/api/insert3')
       .then(function(response){
          return response.json();
        })
       .then(function(myJson) {
  ...
  const TableRow = (props) => {
    const { brand, model, year, registration, color, engine_type} = props;
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">Year</th>
              <th className="border-bottom">Registration</th>
...
export const TransactionsTable3 = () => {
...
const getReservation3 = async () =>  
  {
    fetch('http://localhost:3001/api/insert4')
       .then(function(response){
          return response.json();
        })
       .then(function(myJson) {
  ...
  const TableRow = (props) => {
    const { service, date, time, comment} = props;
